...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-2 rounded-md border border-input bg-card px-3.5 py-2 text-sm text-foreground whitespace-nowrap shadow-sm",
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default select-none items-center gap-2 rounded-md py-2 pl-2.5 pr-8 text-sm outline-hidden",
        "focus:bg-secondary focus:text-foreground data-[state=checked]:font-semibold data-[state=checked]:text-foreground",
